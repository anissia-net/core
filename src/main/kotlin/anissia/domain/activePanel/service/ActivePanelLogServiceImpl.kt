...
class ActivePanelLogServiceImpl(
    ...
    override suspend fun getList(cmd: GetListActivePanelCommand, sessionItem: SessionItem): Page<ActivePanelItem> {
        cmd.validate()
    ...
    override suspend fun addText(cmd: AddTextActivePanelCommand, sessionItem: SessionItem?): ResultWrapper<Unit> {
    ...
    override suspend fun addNotice(cmd: DoCommandActivePanelCommand, sessionItem: SessionItem): ResultWrapper<Unit> {
